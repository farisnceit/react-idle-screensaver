...
export function ScreensaverManagerDebug<T extends Record<string, unknown> = Record<string, unknown>>({
    children,
    ...
    return (
        <ScreensaverContext.Provider value={{ isIdle }}>
            <div style={{ minHeight: '100vh', position: 'relative' }}>
                <div style={{ filter: shouldShow ? 'blur(4px)' : undefined }}>{children}</div>

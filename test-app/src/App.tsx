            ...
            <div className="app-container">
                <header className="app-header">
                    ...
                    <p className="subtitle">
                        A lightweight React component for detecting user inactivity and displaying customizable screensavers
                    </p>
                    ...
                    <div className="code-block-wrapper">
                        <div className="code-block">
                            <div className="code-header">
                                ...
                                <button
                                    className="copy-btn"
                                    onClick={() => navigator.clipboard.writeText('npm install @farizbytes/react-idle-screensaver')}
                                >
                                    📋 Copy
                                </button>
                            </div>
                        ...
                        <div className="code-block">
                            <div className="code-header">
                                ...
                                <button
                                    className="copy-btn"
                                    onClick={() => navigator.clipboard.writeText('yarn add @farizbytes/react-idle-screensaver')}
                                >
                                    📋 Copy
                                </button>
                            </div>
                        ...
                        <div className="code-block">
                            <div className="code-header">
                                ...
                                <button
                                    className="copy-btn"
                                    onClick={() => navigator.clipboard.writeText('pnpm add @farizbytes/react-idle-screensaver')}
                                >
                                    📋 Copy
                                </button>
                            </div>
      ...
      <YourApp />
                ...
                <section className="section demo-section">
                    ...
                    <p className="section-description">
                        Try different screensavers and adjust their properties in real-time.
                        Stop interacting for {timeout / 1000} seconds to see the screensaver.
                    </p>
                    ...
                    <div className="demo-grid">
                        ...
                        <div className="demo-panel">
                            ...
                            <div className="control-group">
                                <label>
                                    ...
                                    <span className="label-value">{timeout}ms ({timeout / 1000}s)</span>
                                </label>
                                <input
                                    type="range"
                                    min="2000"
                        ...
                        <div className="demo-panel full-width">
                            <h3>🎛️ Component Props for {screensaverType.charAt(0).toUpperCase() + screensaverType.slice(1)}</h3>
                                ...
                                <div className="props-grid">
                                    <div className="control-group">
                                        <label>
                                            ...
                                            <span className="label-value">{sliderInterval}ms ({sliderInterval / 1000}s)</span>
                                        </label>
                                        <input
                                            type="range"
                                            min="2000"
                                    ...
                                    <div className="control-group">
                                        ...
                                        <p className="hint">Array of image URLs (currently using {sampleImages.length} sample images)</p>
                                    </div>
                                </div>
                            )}
                        ...
                        <div className="demo-panel">
                            <h3>🎯 Test Area</h3>
                            <p className="hint">Interact here, then stop for {timeout / 1000}s to trigger the screensaver</p>
                    ...
                    <div className="api-table-wrapper">
                        ...
                        <table className="api-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><code>onScreenSaverStop</code></td>
                        ...
                        <table className="api-table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><code>"System Standby"</code></td>
                ...
                <footer className="app-footer">
                    <p>Made with ❤️ by <a href="https://farizbytes.com" target="_blank" rel="noopener noreferrer">FarizBytes</a></p>
                    <p className="small">
                        <a href="https://github.com/farisnceit/react-idle-screensaver" target="_blank" rel="noopener noreferrer">
                            📦 View on GitHub
                        </a>
                        {' • '}
                        <a href="https://www.npmjs.com/package/@farizbytes/react-idle-screensaver" target="_blank" rel="noopener noreferrer">
                            📚 View on NPM
                        </a>
                    </p>
                </footer>

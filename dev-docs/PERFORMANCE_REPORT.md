...
## `@farizbytes/react-idle-screensaver` v0.1.0
...
Add to README:
```markdown
![Bundle Size](https://img.shields.io/bundlephobia/minzip/@farizbytes/react-idle-screensaver)
```
...
|---------|-------------|----------|-------------|
| **@farizbytes/react-idle-screensaver** | **9.5 KB** | 5 screensavers + hooks | ⭐⭐⭐⭐⭐ |

...
.ris-overlay-gradient {
    background: linear-gradient(0deg, rgba(0, 0, 0, 0.85), transparent, rgba(0, 0, 0, 0.3));
    inset: 0;
    position: absolute;
}
.ris-slider-content {
...
```tsx
// Import the CSS file
import '@mohamedfariz/react-idle-screensaver/dist/index.esm.css';
